        ...
        if ($this->isPostBack()) {
            ...
            if ($processPayment) {
                $PayPalOrder = new \Utilities\Paypal\PayPalOrder(
                    "test" . (time() - 10000000),
                    "http://localhost:8080/ProyectoNegociosWebFinal_8/index.php?page=Checkout_Error",
                    "http://localhost:8080/ProyectoNegociosWebFinal_8/index.php?page=Checkout_Accept"
                );
